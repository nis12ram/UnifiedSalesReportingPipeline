# **Multi-Region Sales Data Pipeline** (UnifiedSalesReportingPipeline) | _An End-to-End Azure Lakehouse Project for Reliable, Scalable Multi-Region Sales Reporting_ (***project 2***)
